...
const API_URL = 'https://adirapi.herokuapp.com/api/';
...
export class UserService {
  ...
  private users = 'https://cometaa.herokuapp.com/api/users';

  private usersbyrole = 'https://cometaa.herokuapp.com/api/userbyRoleid';


  private changerpassword = 'https://cometaa.herokuapp.com/api/auth/changepassword';
